...
export function Modalwindow(props: PropsType) {
    ...
    return (
        <Container>
            ...
            {/*синее поле с текстом и кнопкой открытия модального окна*/}
            <BannerContainer>
                <BannerTitle>Библиотека презентаций МИУДОЛ</BannerTitle>
                <BannerText>Быстрый доступ ко всем необходимым материалам для эффективной работы</BannerText>
                <Button onClick={openModal}>Отправить презентацию</Button>
                <BannerDescription>Загружайте и скачивайте нужные материалы за секунды</BannerDescription>
            </BannerContainer>
